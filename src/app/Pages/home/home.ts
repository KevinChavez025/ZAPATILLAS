...
export class Home implements AfterViewInit {
  ...
  readonly categorias = [
    { nombre: 'Baby Piolito', edad: '0 – 7 meses',  tallas: '15 – 19', icon: '🍼', gradient: 'linear-gradient(160deg, #9e2428, #C22D31)', linea: 'baby-piolito' },
    { nombre: 'Tilin',        edad: '8 – 18 meses',  tallas: '18 – 21', icon: '👣', gradient: 'linear-gradient(160deg, #27287a, #343594)', linea: 'tilin' },
    { nombre: 'Piolito',      edad: '18m – 9 años',  tallas: '22 – 38', icon: '🏃', gradient: 'linear-gradient(160deg, #d4a800, #ECC238)', linea: 'piolito' },
    { nombre: 'Urbano',       edad: '9 – 14 años',   tallas: '27 – 38', icon: '⚡', gradient: 'linear-gradient(160deg, #075e2e, #089347)', linea: 'urbano' },
  ];
  ...
  // ─── Navegar a productos con filtro de línea preseleccionado ───
  irAColeccion(linea: string) {
